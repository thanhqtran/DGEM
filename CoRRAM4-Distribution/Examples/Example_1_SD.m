%{
    ...
    Purpose: Solve and simulate the model of Section 3.4.1 of the CoRRAM user manual. This version empolys symbolic differentiation
             and requires the Matlab symbolic toolbox.
...
BM.Equations='Example_1_Eqs_SD';
BM.VarSym={'k';'y';'c';'i';'n';'z'};
BM.VarVal=[kstar;ystar;cstar;istar;nstar;0];
BM.ParSym={'a';'alpha';'beta';'eta';'delta';'theta'};
